...
exports.NotebooksService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const notebook_entity_1 = require("./entities/notebook.entity");
let NotebooksService = class NotebooksService {
    notebookRepo;
    constructor(notebookRepo) {
...
exports.NotebooksService = NotebooksService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(notebook_entity_1.Notebook)),
